...
import Layout from '@geocine/gatsby-theme-organization/src/components/Layout'
        ...
        >
          {projects.map((project, key) => (
            <Box sx={{ width: ['100%', '50%', '33%'], px: 2, py: 2 }} key={key}>
              <InfoCard name={project.name} url={project.url} tags={project.tags} description={project.description}>
